...
% This thesis examined imitation learning as a promising approach for enabling robots to acquire complex skills from demonstrations, moving towards the long-term goal of general-purpose robotic intelligence.
% The thesis explains in detail fundamental concepts in machine learning and robotics and provides basic knowledge about the data, what is needed to train a generalist robot and in a general way how robots can be instructed to perform desired tasks.
% It then focuses on the central research questions of Learning from Videos, how relevant knowledge can be extracted from internet videos and this knowledge be subsequently transferred to robotic systems for policy learning and control. The thesis further explores the role of robust video understanding in imitation learning, highlighting the capabilities required for robots to interpret human demonstrations.
% Afterthere various approaches are discussed for learning coherent robot models from video data, including foundational perception and representation learning methods, reinforcement learning-based and imitation learning approaches, hybrid methods that combine both paradigms, as well as large-scale \acf{VLA} models. 
% Major challenges and future research directions in \ac{IL} and video-based robotic learning are examined, highlighting the gap between current research systems and the long-term goal of general-purpose robotic intelligence. Emerging approaches such as diffusion-based policies, world models and causally-aware learning systems offer promising opportunities for overcoming these limitations and improving the adaptability, reasoning capabilities and generalization performance of future robotic agents.
% For practical insights, selected \ac{IL} approaches deployed on real robotic systems are examined, illustrating how \ac{IL} can enable robots to acquire complex manipulation and control skills directly from video demonstrations.

% To the end, practical insights were gained by implementing a basic robot setup for the UR5e robot arm from Universal Robots, which serves as a good starting point for future experiments of robot learning models. 
% Overall, the thesis provides a comprehensive overview 
...
% - **RL-AI-F:** Extracting shaped reward functions from video-to-text models via **RL from \ac{AI} feedback (RL-AI-F) methods** is an avenue for future work.
