...
\ac{RL} is both a fundamental discipline of machine learning and a distinct approach within Robot Learning.
...
\paragraph{Knowledge Modality from Video}
...
Behavior Cloning (BC) is a fundamental approach within \ac{IL}, where a policy is learned directly from \textbf{annotated expert demonstrations} \cite{Eze2024LearningBW}. The training data consists of state-action pairs $(s_t, a_t)$, and the problem is formulated as a standard supervised learning task.  
