...
An MDP also defines a reward function that specifies the reward $r$ an agent receives when taking action $a$ in state $s$ and transitioning to a subsequent state $s'$. This is commonly expressed as $R_a(s,s')$ \cite{sutton2018reinforcement, millerMarkovDecisionProcesses}.
