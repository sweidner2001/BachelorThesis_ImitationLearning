...
In addition, general-purpose robots could play an important role in \texttt{household} settings. They could assist with everyday tasks such as tidy up rooms, loading/unloading dishwashers, setting tables, or acting as general assistants for example helping to carry objects.
