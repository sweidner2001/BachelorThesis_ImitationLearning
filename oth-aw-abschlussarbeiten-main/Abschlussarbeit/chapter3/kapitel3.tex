...
\begin{figure}[!ht]
	...
	\caption[Problem: Data Bottleneck in Robotics]{Problem: Data Bottleneck in Robotics. The x-axis represents the spectrum of behaviors that a generalist robot is expected to perform, while the y-axis reflects the different information levels present in the data sources. Internet data covers a wider range of behaviors than robot datasets but lacks low-level robotic information required for control, making this gap a key challenge in \ac{LfV}. Image source:~\cite{McCarthy_2025}.}
...
Furthermore, language serves as a bridge for incorporating prior knowledge about object affordances, physical interactions or human behaviors into robotic systems for example from \acp{LLM}. 
