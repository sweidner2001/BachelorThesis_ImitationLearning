...
\begin{figure}[h]
	...
	\subfigure[Task: Rotate cup and place it on table]{
		\parbox{4.5cm}{
			\centering
			\textbf{Put fruit into bowl}\par
			\vspace{0.3em}
			\includegraphics[width=\linewidth]{./chapter2/media/CNNCatPrewittOriginal}
		}
	}
	\hspace{0.5cm}
	\subfigure[Task: Put fruit into bowl]{
		% \textbf{Put fruit into bowl}
		\includegraphics[width=4.5cm]{./chapter2/media/CNNCatPrewittHorizontal_2}
		\label{fig:CNNCatPrewittHorizontal_2}
	}
	\hspace{0.5cm}
	\subfigure[Task: Fold T-shirt]{
		% \textbf{Put fruit into bowl}
		\includegraphics[width=4.5cm]{./chapter2/media/CNNCatPrewittVertical_2}
		\label{fig:CNNCatPrewittVertical_2}
	}
	\caption[Image-based instructions for task execution.]{Image-based instructions for task execution. Image source: \cite{bai_LearningSeeAct_2025}.}
...
% \begin{figure}
% 	\centering
% 	\includegraphics[width=0.65\linewidth]{./chapter2/media/CNNPipeline}
% 	\caption[CNN Pipeline]{CNN Pipeline. Image based on \cite{Vaswani2017AttentionIA}.}
