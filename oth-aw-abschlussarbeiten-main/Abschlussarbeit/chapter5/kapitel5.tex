...
Videos are a challenging data modality, as you have seen in~\autoref{sec:ChallengesOfVideoData}. This chapter addresses the two key questions for \ac{LfV} research:
\begin{enumerate}
