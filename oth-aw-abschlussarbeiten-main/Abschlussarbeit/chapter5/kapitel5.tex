...
\begin{itemize}
    \item (i) \textbf{Missing action labels}: Most video datasets do not contain explicit robot action annotations, which are required for learning robot control policies \cite{McCarthy_2025}.
...
\]
where
$\hat{A}$ denotes an Alternative (latent or abstract) Action Representation Space. 
